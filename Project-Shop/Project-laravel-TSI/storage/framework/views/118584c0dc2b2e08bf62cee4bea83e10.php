<?php $__env->startSection('contenido-principal'); ?>
    <div class="container mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="<?php echo e(asset('images/polera_lana.jpg')); ?>" class="card-img-top" alt="Producto 2">
                    <div class="card-body">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\TSI-Tienda\Project-Shop\Project-laravel-TSI\resources\views/Productos/index.blade.php ENDPATH**/ ?>