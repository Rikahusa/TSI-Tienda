<?php $__env->startSection('contenido-principal'); ?>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo e(asset('images/Amiguri.png')); ?>" class="d-block w-25" alt="amiguri-playholder">
                    <img src="<?php echo e(asset('images/Falda.png')); ?>" class="d-block w-25" alt="polera-playholder">
                </div>
            </div>
            <div class="carousel-item active">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo e(asset('images/Fiestas.png')); ?>" class="d-block w-25" alt="...">
                    <img src="<?php echo e(asset('images/Gorro_extras.png')); ?>" class="d-block w-25" alt="...">
                </div>
            </div>
            <div class="carousel-item active">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo e(asset('images/Llaveros.png')); ?>" class="d-block w-25" alt="...">
                    <img src="<?php echo e(asset('images/Sueter.png')); ?>" class="d-block w-25" alt="...">
                </div>
            </div>
        </div>
    </div>
    <div class="container mt-5">   
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img src="<?php echo e(asset('images/Amiguri.png')); ?>" class="card-img-top" alt="Producto 1">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="<?php echo e(asset('images/Falda.png')); ?>" class="card-img-top" alt="Producto 2">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="<?php echo e(asset('images/amigurumi_2.png')); ?>" class="card-img-top" alt="Producto 3">
                    <div class="card-body">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\TSI-Tienda\Project-Shop\Project-laravel-TSI\resources\views/home/welcome.blade.php ENDPATH**/ ?>